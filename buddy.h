...
class Buddy{
	public:
		Buddy(){
            ...
            this->l_elbow1 = new Sphere(-1.2505, 3.2, 0.0, 0.0, 0.9);
            this->r_elbow1 = new Sphere(1.2505, 3.2, 0.0, 0.0, 0.9);
            this->l_elbow2 = new Sphere(-1.2495, 3.2, 0.0, 0.0, 0.1);
            this->r_elbow2 = new Sphere(1.2495, 3.2, 0.0, 0.0, 0.1);
            this->l_wrist = new Sphere(-1.25, 2.2, 0.0, 0.0, 1.0);
            this->r_wrist = new Sphere(1.25, 2.2, 0.0, 0.0, 1.0);
            this->l_knee1 = new Sphere(-0.5005, 1.5, 0.0, 0.0, 0.9);
            this->r_knee1 = new Sphere(0.5005, 1.5, 0.0, 0.0, 0.9);
            this->l_knee2 = new Sphere(-0.4995, 1.5, 0.0, 0.0, 0.1);
            this->r_knee2 = new Sphere(0.4995, 1.5, 0.0, 0.0, 0.1);
