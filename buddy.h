...
class Buddy{
	public:
		Buddy(){
            ...
            this->l_elbow1 = new Sphere(-1.2505, 3.2, 0.0, 0.0, 9);
            this->r_elbow1 = new Sphere(1.2505, 3.2, 0.0, 0.0, 9);
            ...
            this->l_knee1 = new Sphere(-0.5005, 1.5, 0.0, 0.0, 9);
            this->r_knee1 = new Sphere(0.5005, 1.5, 0.0, 0.0, 9);
