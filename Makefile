...
ifeq ($(shell sw_vers 2>/dev/null | grep Mac | awk '{ print $$2}'),Mac)
	...
	LDFLAGS = -lm -lstdc++ -framework GLUT -framework OpenGL \
	 	...
	 	-lfreeimage ./FreeImage/libfreeimage.a -L./FreeImage -pthread\
	 	#-L"/usr/lib" irrKlang-1.4.0/bin/linux-gcc/libIrrKlang.so 
else
	CFLAGS = -g -DGL_GLEXT_PROTOTYPES -Iglut-3.7.6-bin\
		-IirrKlang-1.4.0/include -I/usr/local/include -I/usr/include -I/home/ff/cs184/eigen -I/usr/include/eigen3 -pthread -O3 
	LDFLAGS = -ljpeg -lGL -lGLU -lm -lstdc++ -lglut -lfreeimage -L./FreeImage -L"/usr/lib" -pthread #irrKlang-1.4.0/bin/linux-gcc/libIrrKlang.so
