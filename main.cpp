...
void myKeys(unsigned char key, int x, int y) {
  ...
  switch(key) {
	case ESCAPE:
		...
		break;
	case W_KEY:
		temp_cam_pos_x = cam_pos_x + double(sin(cam_rot_y/180 * PI)) * 0.2;
		temp_cam_pos_z = cam_pos_z + double(cos(cam_rot_y/180 * PI)) * 0.2;
    if(withinBoxBoundry(temp_cam_pos_x, temp_cam_pos_z)){
      ...
      cam_pos_z = temp_cam_pos_z;
		...
		break;
	case A_KEY:
		temp_cam_pos_x = cam_pos_x - double(cos(cam_rot_y/180 * PI)) * 0.2;
		temp_cam_pos_z = cam_pos_z - double(sin(cam_rot_y/180 * PI)) * 0.2;
    if(withinBoxBoundry(temp_cam_pos_x, temp_cam_pos_z)){
      cam_pos_x = temp_cam_pos_x;
      cam_pos_z = temp_cam_pos_z;
    }
